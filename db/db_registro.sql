...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2017 a las 02:17:11
...
(17, 2, NULL, NULL, '0501-2012-19402', 'Big', 'Guy', '2012-12-12', 'M', 'bane@gmail.com', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', '../imagenes/bane.jpg'),
(18, 4, 3, 3, '0501-2012-92029', 'Hatsune', 'Miku', '2012-12-12', 'F', 'miku@gmail.com', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', '../imagenes/miku.png');
...
--
ALTER TABLE `tbl_asignaturas`
  MODIFY `codigo_asignatura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `tbl_aulas`
--
ALTER TABLE `tbl_aulas`
  MODIFY `codigo_aula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `tbl_secciones`
  MODIFY `codigo_seccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
